    ...
    <div class="col-md-3">
        <div class="dashboard-menus panel panel-info">
            <div class="panel-body alert-success_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/videos-2.jfif')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('Videos', $language_strings)}} <label class="video_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="dashboard-menus panel panel-info">
            <div class="panel-body alert-danger_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/audios-4.png')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('Audios', $language_strings)}} <label class="audio_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="dashboard-menus panel panel-info">
            <div class="panel-body alert-info_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/images-3.jfif')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('Images', $language_strings)}} <label class="image_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="panel panel-info">
            <div class="dashboard-menus panel-body alert-warning_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/News_Paper.png')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('News_Paper', $language_strings)}} <label class="news_paper_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
...
@if($currentUser->isGranted('documents.index'))
    ...
    <div class="col-md-3">
        <div class="panel panel-info">
            <div class="dashboard-menus panel-body alert-warning_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/Magazine.png')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('Magazine', $language_strings)}} <label class="magazine_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
...
@if($currentUser->isGranted('documents.index'))
    ...
    <div class="col-md-3">
        <div class="panel panel-info">
            <div class="dashboard-menus panel-body alert-warning_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/Book.png')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('Book', $language_strings)}} <label class="book_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
...
@if($currentUser->isGranted('documents.index'))
    ...
    <div class="col-md-3">
        <div class="panel panel-info">
            <div class="dashboard-menus panel-body alert-warning_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/Text_Document.png')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('Text_Document', $language_strings)}} <label class="text_document_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="panel panel-info">
            <div class="dashboard-menus panel-body alert-success_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/documents-2.png')}}" style="width: 100%;height: 105px;">
                </div>
                
            <div class="col-xs-12" >
                <h4>{{App\Global_var::getLangString('All_Documents', $language_strings)}} <label class="total_documents badge bg-orange"></label></h4>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="panel panel-info">
            <div class="dashboard-menus panel-body alert-danger_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/users-3.jfif')}}" style="width: 100%;height: 105px;">
                </div>
    ...
    <div class="col-md-3">
        <div class="panel panel-info">
            <div class="dashboard-menus panel-body alert-info_">
                <div class="col-xs-12">
                    <img src="{{asset('images/icons/logs-2.png')}}" style="width: 100%;height: 105px;">
                </div>
