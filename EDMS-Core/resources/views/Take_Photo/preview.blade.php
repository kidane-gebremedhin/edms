...
<body>
	...
	<script type="text/javascript" src="../Take_photo/webcam.min.js"></script>
	...
	<script language="JavaScript">
		...
		shutter.src = navigator.userAgent.match(/Firefox/) ? '../Take_photo/shutter.ogg' : '../Take_photo/shutter.mp3';
