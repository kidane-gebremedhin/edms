        ...
        <div class="panel-body">
          ...
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              <a class="get myTooltip btn btn-default btn-md" href="{{route('users.show', $user->id)}}">
                <i class="fa fa-eye"></i> 
               ...
               @endif
                @if($currentUser->isGranted('users.approveNewUser'))
                  <a class="get myTooltip btn btn-md btn-success" href="{{route('users.approveNewUser', [$user->id, 1])}}" nextUrl="{{route('users.newUsers')}}"><i class="fa fa-check"></i>
                    <span class="tooltiptext">{{App\Global_var::getLangString('Approve', $language_strings)}}</span>
                    </a>
                    <a class="get myTooltip btn btn-md btn-danger" href="{{route('users.approveNewUser', [$user->id, 0])}}" nextUrl="{{route('users.newUsers')}}"><i class="fa fa-close"></i>
