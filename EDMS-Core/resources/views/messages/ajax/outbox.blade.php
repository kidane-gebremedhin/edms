  ...
  <div class="panel-heading">
      <h4>
        ...
        <a style="margin-right: 30px" class="get navbar-right" href="{{route('messages.create')}}" nextUrl="{{route('messages.create')}}"><i class="fa fa-plus"></i> 
          {{App\Global_var::getLangString('Create_New_Message', $language_strings)}}
        </a>
      </h4>
      </div>
  <div class="panel-body">
      @if(count($outboxMessages)>0)
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr class="messageRow" messageId='{{$message->id}}' style="background: #ccffcc; color: orange; font-weight: bold; border-left: 5px solid orange; border-right: 1px solid green">
            ...
            <td>      
              <a class="get btn btn-default btn xs" href="{{route('messages.show_outbox', $message->id)}}"><i class="fa fa-eye"> </i></a>
            </td>
          </tr>
          <tr>
          <td colspan="5">
            <div class="{{$message->id}}_detailArea detailArea" isVisible="false" style="display: none;">
              <div class="col-md-10 col-md-offset-2">
                ...
                <p>{{App\Global_var::getLangString('Recipients', $language_strings)}}: 
