...
<hr>
	...
	<a href="{{route('departments.edit', $department->id)}}" value="{{$department->id}}" class="get btn btn-sm btn-primary" nextUrl="{{route('departments.edit', $department->id)}}"><i class="fa fa-edit"></i> 
		{{App\Global_var::getLangString('Edit', $language_strings)}}
	</a>
	<a href="{{route('departments.delete', $department->id)}}" value="{{$department->id}}" class="get btn btn-sm btn-danger" nextUrl="{{route('departments.delete', $department->id)}}"><i class="fa fa-trash"></i> 
