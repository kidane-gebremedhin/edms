    ...
    <div class="col-md-12">
        <div class="panel panel-success">
            <div class="panel-heading">                
                {{App\Global_var::getLangString('Edit_Edition', $language_strings)}} 
                <a href="{{route('documents.show', $document_edition->document->id)}}" class="get btn btn-success btn-sm pull-right"><i class="fa fa-eye"></i> 
            ...
            <div class="panel-body">
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade active in" id="orgDetails">
                        {!!Form::model($document_edition, array("route"=>["documents.update_edition", $document_edition->id], "files"=>true, "method"=>"POST", "class"=>"post"))!!}
                        <label class="nextUrl col-md-12" nextUrl="{{route('documents.show', $document_edition->document->id)}}" />
                    <div class="col-md-6"> 
