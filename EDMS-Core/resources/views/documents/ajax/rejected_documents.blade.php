            ...
            <tbody>
              ...
              <a class="get myTooltip btn btn-default btn-md" href="{{route('documents.show', $document->id)}}">
               ...
               @endif
                ...
                <a class="get myTooltip btn btn-md btn-success" href="{{route('documents.approveNewDocument', [$document->id, 1])}}" nextUrl="{{route('documents.rejectedDocuments')}}"><i class="fa fa-check"></i>  
